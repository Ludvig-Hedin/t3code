...
> **This is the single source of truth for shared project context.**
> Both `AGENTS.md` (Claude/Codex) and `GEMINI.md` (Gemini CLI) reference this file.
> When adding new project-wide information, update this file — not the agent-specific files.
