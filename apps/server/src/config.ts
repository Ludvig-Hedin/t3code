...
export interface ServerDerivedPaths {
  ...
  readonly mobileDevicesPath: string;
...
export const deriveServerPaths = Effect.fn(function* (
  ...
  return {
    ...
    mobileDevicesPath: join(stateDir, "mobile-devices.json"),
...
export const ensureServerDirectories = Effect.fn(function* (derivedPaths: ServerDerivedPaths) {
  ...
  yield* Effect.all(
    [
      ...
      fs.makeDirectory(path.dirname(derivedPaths.mobileDevicesPath), { recursive: true }),
