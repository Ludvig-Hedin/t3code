...
import Migration0020 from "./Migrations/020_A2aAgentCards.ts";
import Migration0021 from "./Migrations/021_A2aTasks.ts";
...
export const migrationEntries = [
  ...
  [20, "A2aAgentCards", Migration0020],
  [21, "A2aTasks", Migration0021],
] as const;
