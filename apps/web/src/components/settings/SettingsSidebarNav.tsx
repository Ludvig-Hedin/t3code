...
import { ArchiveIcon, ArrowLeftIcon, PlugIcon, Settings2Icon } from "lucide-react";
...
export type SettingsSectionPath = "/settings/general" | "/settings/mcp" | "/settings/archived";
