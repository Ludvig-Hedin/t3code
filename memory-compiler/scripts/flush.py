...
def save_flush_state(state: dict) -> None:
    try:
        ...
        logging.error("Failed to write flush state %s: %s", STATE_FILE, e)
...
def main():
    ...
    # Append to daily log (exact / prefix checks avoid accidental substring matches)
    ...
    elif stripped == "FLUSH_ERROR" or stripped.startswith("FLUSH_ERROR"):
