...
Use this when you want to open Bird Code from another device (phone, tablet, another laptop).

## CLI ↔ Env option map

The Bird Code CLI accepts the following configuration options, available either as CLI flags or environment variables:
